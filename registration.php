...
<div class="container">
        ...
        <div class="row">
            <form action="includes/registrationProcess.php" method="POST" class="form">
                ...
                <div class="mb-3 fs-2 form-group">
                    <input class="btn btn-success fs-2" type="submit" name="reg" id="login" value="Registration"> <a href="../login/index.php">Go to Login Page</a>
                </div>
            </form>
        </div>
